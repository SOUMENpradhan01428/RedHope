    ...
    >
      ...
      <div className="px-6 py-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
          {[
            { title: "Current Stock", value: 345, subtitle: "Total units available", icon: "❤️" },
            { title: "Critical Levels", value: 3, subtitle: "Blood types below minimum", icon: "⚠️" },
            { title: "Active Requests", value: 12, subtitle: "Pending blood requests", icon: "📅" },
            { title: "Donors Found", value: 45, subtitle: "Available in your area", icon: "🩸" },
          ].map((card, i) => (
            <div
              key={i}
        ...
        {/* Form */}
        <div className={`p-4 rounded-xl shadow-sm border mt-6 ${
